...
public class ModFoodComponents {
    ...
    public static final FoodComponent GOLDEN_WORM = new FoodComponent.Builder().nutrition(5).saturationModifier(10f).snack().statusEffect(new StatusEffectInstance(StatusEffects.HASTE,200),1f).build();
}
